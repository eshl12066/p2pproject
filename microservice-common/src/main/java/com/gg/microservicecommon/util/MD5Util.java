...
//    }
     ...
     * @return 签名结果
     */
    public static boolean verify(String pwd , String mdsum) {
        String s = md5(md5(pwd));
        if (s.equals(mdsum)) {
            return true;
        } else {
            return false;
    ...
    public static void main(String[] args) {
        ...
        try {
            String md5Sum = MD5Util.getMd5Sum(s);
            System.out.println(md5Sum);
            if(MD5Util.verify("123","d9b1d7db4cd6e70935368a1efb10e377")){
